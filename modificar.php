...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">  
        <div class="col-sm-12">     
            <div class="row">
                    ...
                    <div class="col-sm-8">
                            <h2 style="color:white">Modificar Pokemon</h2>
    ...
    if ($conn->connect_error) {
      ...
      <div class="row">
            ...
            <div class="col-sm-6">
                    ...
                    <form action="modificarPokemon.php?id=<?php echo $registro['id_pokemon']?>" method="post" enctype="multipart/form-data" >          
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="tipo" value="<?php echo $registro['tipo'] ?>">  
                        </div>
