    ...
    <table class="table">
      ...
      <tbody>
          ...
          ?>
                ...
                <tr>
                  <td><?php echo $registro['id_pokemon']?></td>
                  <td><?php echo $registro['nombre']?></td>
                  <td><?php echo $registro['tipo']?></td>
                  <td><img height="35px;" src="data:image/jpg;base64, <?php echo base64_encode($registro['imagen']);?>"></td>
                  <td>[<a href="modificar.php?id=<?php echo $registro['id_pokemon'] ?>">modificar</a>][<a href="eliminar.php?id=<?php echo $registro['id_pokemon'] ?>">eliminar</a>]</td>  
                </tr>
